...
-- 5. GBP review counter reports - one saved snapshot per report run
...
create policy "anon_gbp_review_reports_all" on gbp_review_reports for all using (true) with check (true);
